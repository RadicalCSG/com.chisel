...
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.InternalChiselSurfaceArray>>))]
...
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.BasePolygonsBlob>>))]
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.BrushTreeSpaceVerticesBlob>>))]
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.BrushesTouchedByBrush>>))]
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.RoutingTable>>))]
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.BrushTreeSpacePlanes>>))]
[assembly: Unity.Jobs.RegisterGenericJobType(typeof(Chisel.Core.DisposeListChildrenJob<Unity.Entities.BlobAssetReference<Chisel.Core.ChiselBrushRenderBuffer>>))]
