        ...
        public unsafe void Execute(int index)
        {
            ...
            { 
                for (int o = 0; o < surfaceOuterCount; o++)
                {
                    ...
                    {
                        var inner = new UnsafeList<int>(surfaceInnerCount, Allocator.Temp);
				...
				using var _surfaceLoopAllInfos = surfaceLoopAllInfos = new NativeArray<SurfaceInfo>(surfaceLoopCount, Allocator.Temp);
				...
				using var _surfaceLoopAllEdges = surfaceLoopAllEdges = new NativeList<UnsafeList<Edge>>(surfaceLoopCount, Allocator.Temp);
                ...
                { 
			        ...
			        using var querySurfaceList = new NativeList<ChiselQuerySurface>(surfaceRenderBuffers.Length, Allocator.Temp);			
